...
#### click ⬆
 ...
 <div align="center"><h2>🔥 Career</h2>
  ...
  📈 TABA 4기 이미지 AI 분석 프로젝트 총괄 팀장 / 4조 팀장, 기획 및 개발(앱) '베스트 리더'상 수여 ( 2023.09 ~ 2023.12)

  🦄 PURPLE: 초개인화 맞춤형 향수추천 플랫폼 / 팀장,기획 및 개발(앱) ( 2023.12 ~ 2024)
 </div>
...
<h2>🪧 Career Ex 🪧</h2>
	...
	<div align=left>
        🦄 PURPLE: 초개인화 맞춤형 향수추천 플랫폼 / 팀장,기획 및 개발(앱) ( 2023.12 ~ 2024)<br><br>
        ...
        <li>데이터베이스 :  </li>
	<li>클라우드 : AWS </li>
        <li>기타 :  Jira, Notion, Discord </li><br>
        <br>
    </div>
